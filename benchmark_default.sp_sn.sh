...
for i in {10..32}
	do
		...
		/home/qli/tool/trinityrnaseq-2.0.5/Trinity --seqType fa --max_memory 30G --left $LEFT_READS --right $RIGHT_READS --CPU 26 --bflyHeapSpaceMax 5G --bflyCPU 19 --KMER_SIZE $i --min_contig_length 75 --output $i.Trinity --full_cleanup
